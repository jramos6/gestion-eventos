...
public class JLabelCoche extends JLabel {
	...
	public static final int TAMANYO_COCHE = 100;  // pÌxels (igual ancho que algo)
	public static final int RADIO_ESFERA_COCHE = 35;  // Radio en pÌxels del bounding circle del coche (para choques)
	private static final boolean DIBUJAR_ESFERA_COCHE = true;  // Dibujado (para depuraciÛn) del bounding circle de choque del coche
